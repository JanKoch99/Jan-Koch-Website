        ...
        <form (ngSubmit)="submitForm()" #contactForm = "ngForm">
          ...
          <div class="field">
            ...
            <div class="help is-error" *ngIf="emailInput.invalid && nameInput.touched">
              You Email is required and needs to be a valid email.
            </div>
          </div>
          <!-- message -->
          <div class="field">
          ...
          <!-- submit button -->
          <button 
              type="submit" class="button is-large is-warning" [disabled]="contactForm.invalid">
            Send!
          </button>
        </form>
      </div>
...
export class ContactComponent implements OnInit {
  ...
  submitForm(){
    const message = `Hello ${this.name}, your form is submitted.`;
    alert(message)
  }
